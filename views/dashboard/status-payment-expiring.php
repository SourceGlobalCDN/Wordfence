...
<div id="<?php echo esc_attr($id); ?>" class="wf-status-detail">
    <div class="wf-status-payment-expiring">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 644">
            <g>
                <path style="fill:none" d="M66.3,269.5v205.4c0,2.9,1.1,5.5,3.2,7.6c2.1,2.1,4.7,3.2,7.6,3.2h413.6c8.8-72,65.8-129.1,137.8-138v-78.2
		H66.3z M196,442.4h-86.5l0-43.2H196V442.4z M369,442.4H239.3v-43.2H369V442.4z"/>
                <path style="fill:none" d="M628.4,64.1c0-2.9-1.1-5.4-3.2-7.6c-2.1-2.1-4.7-3.2-7.6-3.2H77.1c-2.9,0-5.5,1.1-7.6,3.2s-3.2,4.7-3.2,7.6
		v75.7h562.1V64.1z"/>
                <g>
                    <path style="fill:none" d="M617.6,53.3H77.1c-2.9,0-5.5,1.1-7.6,3.2s-3.2,4.7-3.2,7.6v75.7h562.1V64.1c0-2.9-1.1-5.4-3.2-7.6
			C623.1,54.3,620.5,53.3,617.6,53.3z"/>
                    <path d="M655.8,25.9C645.2,15.3,632.5,10,617.6,10H77.1c-14.9,0-27.6,5.3-38.2,15.9C28.3,36.5,23,49.2,23,64.1v410.8
			...
			c2.1,2.1,3.2,4.7,3.2,7.6V139.7z"/>
                    <rect x="109.5" y="399.2" width="86.5" height="43.2"/>
                    <rect x="239.3" y="399.2" width="129.7" height="43.2"/>
                </g>
                <g>
                    <path d="M759.7,440.3c-11.5-19.8-27.2-35.4-46.9-46.9C693,381.8,671.4,376,648,376s-45,5.8-64.7,17.3
