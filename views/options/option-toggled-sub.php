...
<ul class="wf-flex-vertical wf-flex-full-width">
    <li>
        <ul id="<?php echo esc_attr($id); ?>" class="wf-option wf-option-toggled<?php if (!wfConfig::p() && isset($premium) && $premium) {
    ...
    <li class="wf-option-sub">
        <ul id="<?php echo esc_attr($subID); ?>" class="wf-option wf-option-toggled<?php if (!wfConfig::p() && isset($subPremium) && $subPremium) {
            echo ' wf-option-premium';
            ...
            <li class="wf-option-checkbox<?php echo($subValue == $subEnabledValue ? ' wf-checked' : ''); ?>" role="checkbox" aria-checked="<?php echo($subValue == $subEnabledValue ? 'true' : 'false'); ?>" tabindex="0" aria-labelledby="<?php echo esc_attr($subID); ?>-label">
                <i class="wf-ion-ios-checkmark-empty" aria-hidden="true"></i></li>
            <li class="wf-option-title">
