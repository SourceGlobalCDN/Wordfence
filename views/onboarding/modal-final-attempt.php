...
<div class="wf-modal" id="wf-onboarding-final-attempt">
	...
	<div class="wf-modal-content">
        ...
        <div id="wf-onboarding-final-attempt-2"
             class="wf-onboarding-modal-content"<?php if (wfConfig::get('onboardingAttempt3') != wfOnboardingController::ONBOARDING_THIRD_EMAILS) {
            ...
            <div id="wf-onboarding-license"><input type="text"
                        ...
                        id="wf-onboarding-license-install"
            ...
            <div id="wf-onboarding-license-footer">
                <ul>
                    <li><a href="https://www.wordfence.com/gnl1onboardingFinalGet/wordfence-signup/#premium-order-form"
                    ...
                    <li><a href="https://www.wordfence.com/gnl1onboardingFinalLearn/wordfence-signup/"
            ...
            <div id="wf-onboarding-license-finished" style="display: none;">
                <ul>
                    <li><a href="<?php echo esc_attr(network_admin_url('admin.php?page=Wordfence')); ?>"
                           class="wf-onboarding-btn wf-onboarding-btn-primary"><?php esc_html_e('Close', 'wordfence'); ?></a>
                    </li>
                </ul>
            </div>
        </div>
    </div>
    <div class="wf-modal-footer"<?php if (wfConfig::get('onboardingAttempt3') == wfOnboardingController::ONBOARDING_THIRD_EMAILS) {
        echo ' style="display: none;"';
    } ?>>
        <ul class="wf-flex-horizontal wf-full-width wf-flex-align-right">
            ...
            <li><a href="#" class="wf-onboarding-btn wf-onboarding-btn-primary wf-disabled" id="wf-onboarding-continue"
