    ...
    <ul class="wf-issue-site-cleaning">
        <li class="wf-issue-summary">
            <ul>
                ...
                <li class="wf-issue-controls"><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                                                 href="https://www.wordfence.com/gnl1scanGetHelpHS/wordfence-site-cleanings/"
                                                 target="_blank"
                                                 rel="noopener noreferrer"><?php esc_html_e('Get Help', 'wordfence'); ?>
