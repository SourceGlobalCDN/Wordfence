 ...
 */
?>
<script type="text/x-jquery-template" id="siteCleaningHighSenseTmpl">
    <ul class="wf-issue-site-cleaning">
        <li class="wf-issue-summary">
            <ul>
                <li class="wf-issue-icon-colored">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140.65 149.02">
                        <defs>
                            <style>.a {
                                    fill: none;
                                }
