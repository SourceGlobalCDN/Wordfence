                ...
                <div class="wf-scan-status-disabled">
                    ...
                    <p>
                        <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="#" target="_blank"
                           rel="noopener noreferrer" id="wf-scan-top-enable-scans"
                           role="button"><?php esc_html_e('Enable Automatic Scans', 'wordfence'); ?><span
			...
			<?php if ($scanner->signatureMode() == wfScanner::SIGNATURE_MODE_COMMUNITY): ?>
                <div>
                    ...
                    <p><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                          href="https://www.wordfence.com/gnl1scanUpgrade/wordfence-signup/#premium-order-form"
                          target="_blank"
                          rel="noopener noreferrer"><?php esc_html_e('Upgrade to Premium', 'wordfence'); ?></a>&nbsp;&nbsp;<a
                                class="wf-btn wf-btn-callout-subtle wf-btn-default"
                                href="https://www.wordfence.com/gnl1scanLearn/wordfence-signup/" target="_blank"
