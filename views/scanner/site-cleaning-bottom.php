            ...
            <li>
                <div class="wf-flex-vertical">
                    ...
                    <p class="wf-center wf-add-bottom">
                        <a class="wf-btn wf-btn-default wf-btn-callout-subtle" href="https://www.wordfence.com/gnl1scanLowerAd/site-security-audit/" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Audit My Site Security', 'wordfence'); ?>
                            <span class="screen-reader-text"> (<?php esc_html_e('opens in new tab', 'wordfence') ?>)</span></a>
                        &nbsp;&nbsp;&nbsp;
                        <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="https://www.wordfence.com/gnl1scanLowerAd/wordfence-site-cleanings/" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Clean My Hacked Site', 'wordfence'); ?>
                            <span class="screen-reader-text"> (<?php esc_html_e('opens in new tab', 'wordfence') ?>)</span></a>
                    </p>
                </div>
            </li>
