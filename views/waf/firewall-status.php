        ...
        <li>
            <?php if ($firewall->firewallMode() == wfFirewall::FIREWALL_MODE_DISABLED): ?>
                <div class="wf-waf-status-disabled">
                    <p>
                    <h3><?php esc_html_e('Wordfence Firewall Deactivated', 'wordfence'); ?></h3></p>
                    ...
                    <p>
                        <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="#" target="_blank" rel="noopener noreferrer" id="waf-top-enable-firewall" role="button"><?php esc_html_e('Enable Firewall', 'wordfence'); ?>
            ...
            <?php else: ?>
                <?php if ($firewall->firewallMode() == wfFirewall::FIREWALL_MODE_ENABLED): ?>
                    <div class="wf-block-labeled-value wf-waf-status wf-waf-status-<?php echo esc_attr($firewall->firewallMode()); ?>">
                        <div class="wf-block-labeled-value-value"><i class="wf-fa wf-fa-check" aria-hidden="true"></i>
                        </div>
                ...
                <?php elseif ($firewall->firewallMode() == wfFirewall::FIREWALL_MODE_LEARNING): ?>
                    <div>
                        ...
                        ?>
                        <p>
                        <h3><?php echo($learningMode === true ? esc_html__('Learning Mode Enabled', 'wordfence') : esc_html(sprintf(/* translators: Localized date. */ __('Learning Mode Until %s', 'wordfence'), wfUtils::formatLocalTime(get_option('date_format'), $learningMode)))); ?></h3></p>
                        ...
                        <p>
                            <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="<?php echo esc_url($optionsURL); ?>"><?php esc_html_e('Manage Firewall', 'wordfence'); ?></a>&nbsp;&nbsp;<a class="wf-btn wf-btn-callout-subtle wf-btn-default" href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_FIREWALL_WAF); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn More', 'wordfence'); ?>
                                <span class="screen-reader-text"> (<?php esc_html_e('opens in new tab', 'wordfence') ?>)</span></a>
                        </p>
                    </div>
                <?php endif; ?>
        ...
        <li>
            <?php if ($firewall->ruleMode() == wfFirewall::RULE_MODE_COMMUNITY): ?>
                <div>
                    ...
                    <p>
                        <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="https://www.wordfence.com/gnl1wafUpgrade/wordfence-signup/#premium-order-form" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Upgrade to Premium', 'wordfence'); ?></a>&nbsp;&nbsp;<a class="wf-btn wf-btn-callout-subtle wf-btn-default" href="https://www.wordfence.com/gnl1wafLearn/wordfence-signup/" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn More', 'wordfence'); ?>
                            <span class="screen-reader-text"> (<?php esc_html_e('opens in new tab', 'wordfence') ?>)</span></a>
                    </p>
                </div>
            <?php else: ?>
