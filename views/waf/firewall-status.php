        ...
        <li>
            <?php if ($firewall->firewallMode() == wfFirewall::FIREWALL_MODE_DISABLED): ?>
                <div class="wf-waf-status-disabled">
                    ...
                    <p>
                        <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="#" target="_blank"
                           rel="noopener noreferrer" id="waf-top-enable-firewall"
                           role="button"><?php esc_html_e('Enable Firewall', 'wordfence'); ?><span
                ...
                <?php elseif ($firewall->firewallMode() == wfFirewall::FIREWALL_MODE_LEARNING): ?>
                    <div>
                        ...
                        <p><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                              href="<?php echo esc_url($optionsURL); ?>"><?php esc_html_e('Manage Firewall', 'wordfence'); ?></a>&nbsp;&nbsp;<a
                                    class="wf-btn wf-btn-callout-subtle wf-btn-default"
                                    href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_FIREWALL_WAF); ?>"
                                    target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn More', 'wordfence'); ?>
        ...
        <li>
            <?php if ($firewall->ruleMode() == wfFirewall::RULE_MODE_COMMUNITY): ?>
                <div>
                    ...
                    <p><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                          href="https://www.wordfence.com/gnl1wafUpgrade/wordfence-signup/#premium-order-form" target="_blank"
                          rel="noopener noreferrer"><?php esc_html_e('Upgrade to Premium', 'wordfence'); ?></a>&nbsp;&nbsp;<a
                                class="wf-btn wf-btn-callout-subtle wf-btn-default"
                                href="https://www.wordfence.com/gnl1wafLearn/wordfence-signup/" target="_blank"
