                    ...
                    <ul class="wf-block-list wf-block-list-horizontal">
                        <li id="wf-option-wafStatus" class="wf-flex-vertical wf-flex-align-left wf-flex-full-width">
                            ...
                            <?php else: ?>
                                <p class="wf-no-top">
                                    ...
                                    <span id="wafStatus-enabled-description" class="wafStatus-description"<?php if ($wafStatus != wfFirewall::FIREWALL_MODE_ENABLED) {
                                    ...
                                    <span id="wafStatus-learning-mode-description" class="wafStatus-description"<?php if ($wafStatus != wfFirewall::FIREWALL_MODE_LEARNING) {
                                        echo ' style="display: none;"';
                                    ...
                                    <span id="wafStatus-disabled-description" class="wafStatus-description"<?php if ($wafStatus != wfFirewall::FIREWALL_MODE_DISABLED) {
                                        echo ' style="display: none;"';
                        ...
                        <li id="wf-option-protectionMode" class="wf-flex-vertical wf-flex-align-left">
                            ...
                            <?php if ($firewall->protectionMode() == wfFirewall::PROTECTION_MODE_EXTENDED && !$firewall->isSubDirectoryInstallation()): ?>
                                ...
                                <p class="wf-no-top">
                                    <a class="wf-btn wf-btn-default" href="#" id="wf-waf-uninstall" role="button"><?php esc_html_e('Remove Extended Protection', 'wordfence'); ?></a>
                                </p>
                            <?php elseif ($firewall->isSubDirectoryInstallation()): ?>
                                ...
                                <p>
                                    <a class="wf-btn wf-btn-primary" href="#" id="wf-waf-install" role="button"><?php esc_html_e('Optimize the Wordfence Firewall', 'wordfence'); ?></a>
                                </p>
                            <?php else: ?>
                                <p class="wf-no-top">
                        ...
                        <li id="wf-option-disableWAFBlacklistBlocking" class="wf-flex-vertical wf-flex-align-left">
                            ...
                            <?php if ($firewall->ruleMode() == wfFirewall::RULE_MODE_COMMUNITY): ?>
                                ...
                                <p>
                                    <a class="wf-btn wf-btn-primary wf-btn-callout-subtle" href="https://www.wordfence.com/gnl1blacklistUpgrade/wordfence-signup/#premium-order-form" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Upgrade to Premium', 'wordfence'); ?></a>&nbsp;&nbsp;<a class="wf-btn wf-btn-callout-subtle wf-btn-default" href="https://www.wordfence.com/gnl1blacklistLearn/wordfence-signup/" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn More', 'wordfence'); ?>
