        ...
        <table id="wf-create-block" class="wf-option">
            ...
            <tr class="" style="display: none;">
                ...
                <td class="wf-option-text">
                    ...
                    <?php if (false): ?>
                        <script type="application/javascript" src="<?php echo esc_attr(wfUtils::getBaseURL() . 'js/date.js'); ?>"></script><?php endif; ?>
                </td>
            </tr>
                ...
                <tr class="wf-block-add-country" style="display: none;">
                    <td colspan="2">
                        <ul class="wf-flex-vertical">
                            <li>
                                <h3><?php esc_html_e('Put Geographic Protection In Place With Country Blocking', 'wordfence'); ?></h3>
                            </li>
                            <li>
            ...
            <tr class="wf-block-add-ip" style="display: none;">
                ...
                <td class="wf-option-text wf-padding-add-top-small">
                    <input id="wf-block-ip" type="text" placeholder="<?php esc_attr_e('Enter an IP address', 'wordfence'); ?>">
                </td>
            </tr>
            <tr class="wf-block-add-pattern" style="display: none;">
                ...
                <td class="wf-option-text wf-padding-add-top-small">
                    <input id="wf-block-ip-range" type="text" placeholder="<?php esc_attr_e('e.g., 192.168.200.200 - 192.168.200.220 or 192.168.200.0/24', 'wordfence'); ?>">
                </td>
            </tr>
            <tr class="wf-block-add-pattern" style="display: none;">
                <th class="wf-right wf-padding-add-right wf-padding-add-top-small"><?php esc_html_e('Hostname', 'wordfence'); ?></th>
                <td class="wf-option-text wf-padding-add-top-small">
                    <input id="wf-block-hostname" type="text" placeholder="<?php esc_attr_e('e.g., *.amazonaws.com or *.linode.com', 'wordfence'); ?>">
                </td>
            </tr>
            <tr class="wf-block-add-pattern" style="display: none;">
                ...
                <td class="wf-option-text wf-padding-add-top-small">
                    <input id="wf-block-user-agent" type="text" placeholder="<?php esc_attr_e('e.g., *badRobot*, *MSIE*, or *browserSuffix', 'wordfence'); ?>">
                </td>
            </tr>
            <tr class="wf-block-add-pattern" style="display: none;">
                ...
                (function ($) {
                    $(function () {
                        ...
                        $('#wf-block-add-save').on('click', function (e) {
                            ...
                            WFAD.ajax('wordfence_createBlock', {
