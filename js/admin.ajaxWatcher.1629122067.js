!function (t, e, i) {
    ...
    function r(e, i) {
        i !== Object(i) && (i = {}), this.cache = {}, this.el = e, this.value = function (e) {
            var n;
            return void 0 === this.cache[e] && (n = t(this.el).attr("data-wfbox-" + e), void 0 !== n ? this.cache[e] = n : void 0 !== i[e] ? this.cache[e] = i[e] : void 0 !== X[e] && (this.cache[e] = X[e])), this.cache[e]
        }, this.get = function (e) {
            var i = this.value(e);
    ...
    function g(e) {
        A = 0, e && e !== !1 && "nofollow" !== e ? (W = t("." + tt).filter(function () {
    ...
    function f(i) {
        ...
        if (!G) {
            ...
            v.css({
                ...
                visibility: "visible"
            }).show(), _.get("closeButton") ? P.html(_.get("close")).appendTo(b) : P.appendTo("<div/>"), w()
        }
    }
    ...
    function m() {
        ...
        return x ? (V || (V = !0, B.click(function () {
            J.next()
        }), K.click(function () {
            J.prev()
        }), P.click(function () {
            ...
            var e = t.keyCode;
            U && _.get("escKey") && 27 === e && (t.preventDefault(), J.close()), U && _.get("arrowKey") && W[1] && !t.altKey && (37 === e ? (t.preventDefault(), K.click()) : 39 === e && (t.preventDefault(), B.click()))
    ...
    var v, x, y, b, T, C, H, k, W, E, I, M, L, F, R, S, B, K, P, O, _, j, D, N, z, A, q, U, $, G, Q, J, V, X = {
            html: !1,
            photo: !1,
            iframe: !1,
            inline: !1,
        ...
        }, Y = "wordfenceBox", Z = "wfbox", tt = Z + "Element", et = Z + "_open", it = Z + "_load", nt = Z + "_complete",
    ...
    t[Y] || (t(p), J = t.fn[Y] = t[Y] = function (e, i) {
        ...
        if (U) {
            ...
            I.remove(), I = n(st, "LoadedContent").append(i), I.hide().appendTo(M.show()).css({
                ...
                }, F.html(_.get("title")).show(), I.show(), a > 1 ? ("string" == typeof _.get("current") && R.html(_.get("current").replace("{current}", A + 1).replace("{total}", a)).show(), B[_.get("loop") || a - 1 > A ? "show" : "hide"]().html(_.get("next")), K[_.get("loop") || A ? "show" : "hide"]().html(_.get("previous")), ct(), _.get("preloading") && t.each([h(-1), h(1)], function () {
