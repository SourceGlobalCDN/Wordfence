    ...
    !function (Z) {
        ...
        Z.Zebra_Tooltips = function (t, l) {
            var u, T, b, v, n = {
                ...
                var t, o, i, a, l, n, r, _, s, p, d, h, c, f, w = e.data("Zebra_Tooltip"), m = Z(window);
                return w.tooltip || (t = Z("<div>", {
                    "class": "Zebra_Tooltip",
                    css: {opacity: 0, display: "block"}
                }), o = Z("<div>", {
                    "class": "Zebra_Tooltip_Message",
                    css: {maxWidth: w.max_width}
                }).html(w.content).appendTo(t), i = Z("<div>", {"class": "Zebra_Tooltip_Arrow"}).appendTo(t), a = Z("<div>").addClass("Zebra_Tooltip_Arrow_Border").appendTo(i), Z("<div>").appendTo(i), w.keep_visible && (t.on("mouseleave" + (w.close_on_click ? " click" : ""), function () {
                    y(e)
                ...
                clearTimeout(o.show_timeout), o.muted || (clearTimeout(o.hide_timeout), o.show_timeout = setTimeout(function () {
                    (o = _(t)).onBeforeShow && "function" == typeof o.onBeforeShow && !1 === o.onBeforeShow(t, o.tooltip) || ("block" !== o.tooltip.css("display") && o.tooltip.css({top: o.tooltip_top + o.animation_offset}), o.tooltip.css("display", "block"), o.tooltip.stop(), o.tooltip.animate({
                        top: o.tooltip_top,
                        opacity: o.opacity
            ...
            r.hide = function (t, e) {
                t.each(function () {
                    var t = Z(this), o = t.data("Zebra_Tooltip");
                ...
                var t, o = Z(this), e = o.attr("title"), i = o.data(), a = {};
        ...
        if (log.length) {
            log.closest('form').on('submit', function (e) {
                ...
                if (!registering && parseInt(WFLSVars.useCAPTCHA)) {
                    ...
                    wfls_init_captcha(function () {
                        $('input[name="user_login"]').closest('form').trigger('submit');
                    });
                }
            });
        }
