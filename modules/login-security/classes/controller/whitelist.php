...
class Controller_Whitelist
{
    ...
    protected function _is_valid_bracketed_range($range)
    { //e.g., 192.0.2.[1-10]
        if (preg_match('/[^0-9a-f:\.\[\]\-]/i', $range)) {
            return false;
        }
    ...
    protected function _is_valid_linear_range($range)
    ...
    protected function _is_mixed_range($range)
