...
?>
<ul id="<?php echo esc_attr($id); ?>" class="wfls-option wfls-option-toggled-segmented<?php if (!wfConfig::p() && isset($premium) && $premium) {
    ...
    <li class="wfls-option-title"><?php echo (!empty($title)) ? esc_html($title) : '';
