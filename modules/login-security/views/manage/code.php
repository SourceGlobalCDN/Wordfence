...
<div class="wfls-block wfls-always-active wfls-flex-item-full-width">
    ...
    <div class="wfls-block-content wfls-padding-add-bottom">
        ...
        <p class="wfls-center wfls-no-bottom">
            <input id="wfls-qr-code-text" class="wfls-center" type="text" value="<?php echo esc_attr($base32Secret); ?>" onclick="this.select();" readonly>
        </p>
    </div>
</div>
<script type="application/javascript">
    (function ($) {
        $(function () {
            $('#wfls-qr-code').qrcode({
                text: '<?php echo \WordfenceLS\Text\Model_JavaScript::esc_js($totpURL); ?>',
                width: (WFLS.screenSize(500) ? 175 : 256),
                height: (WFLS.screenSize(500) ? 175 : 256)
            });
