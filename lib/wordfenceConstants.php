...
if (!defined('WORDFENCE_CENTRAL_URL_SEC')) {
    define('WORDFENCE_CENTRAL_URL_SEC', 'https://www.wordfence.com/central');
}
if (!defined('WORDFENCE_CENTRAL_API_URL_SEC')) {
    define('WORDFENCE_CENTRAL_API_URL_SEC', 'https://www.wordfence.com/api/wf');
}
if (!defined('WORDFENCE_CENTRAL_PUBLIC_KEY')) {
    define('WORDFENCE_CENTRAL_PUBLIC_KEY', "\xb6\x33\x81\x05\xdf\xdf\xec\xcf\xf3\xe3\x36\xc6\xf0\x99\xc6\xf7\xca\x05\x36\xca\x87\x54\x53\x43\x31\xf2\xc6\x0d\xe1\x3d\x55\x0f");
}
...
if (!defined('WORDFENCE_SCAN_ISSUES_MAX_REPORT')) {
    define('WORDFENCE_SCAN_ISSUES_MAX_REPORT', 1500);
}
...
if (!defined('WORDFENCE_DISABLE_LIVE_TRAFFIC')) {
    define('WORDFENCE_DISABLE_LIVE_TRAFFIC', false);
}
if (!defined('WORDFENCE_SCAN_ISSUES_PER_PAGE')) {
    define('WORDFENCE_SCAN_ISSUES_PER_PAGE', 100);
}
if (!defined('WORDFENCE_BLOCKED_IPS_PER_PAGE')) {
    define('WORDFENCE_BLOCKED_IPS_PER_PAGE', 100);
}
if (!defined('WORDFENCE_DISABLE_FILE_VIEWER')) {
    define('WORDFENCE_DISABLE_FILE_VIEWER', false);
}
if (!defined('WORDFENCE_SCAN_FAILURE_THRESHOLD')) {
    define('WORDFENCE_SCAN_FAILURE_THRESHOLD', 300);
}
if (!defined('WORDFENCE_SCAN_START_FAILURE_THRESHOLD')) {
    define('WORDFENCE_SCAN_START_FAILURE_THRESHOLD', 15);
}
if (!defined('WORDFENCE_PREFER_WP_HOME_FOR_WPML')) {
    define('WORDFENCE_PREFER_WP_HOME_FOR_WPML', false);
...
if (!defined('WORDFENCE_SCAN_MIN_EXECUTION_TIME')) {
    define('WORDFENCE_SCAN_MIN_EXECUTION_TIME', 8);
}
if (!defined('WORDFENCE_SCAN_MAX_INI_EXECUTION_TIME')) {
    define('WORDFENCE_SCAN_MAX_INI_EXECUTION_TIME', 90);
}
if (!defined('WORDFENCE_ALLOW_DIRECT_MYSQLI')) {
    define('WORDFENCE_ALLOW_DIRECT_MYSQLI', true);
}
if (!defined('WORDFENCE_NOC3_FAILED_BACKOFF_TIME')) {
    define('WORDFENCE_NOC3_FAILED_BACKOFF_TIME', 60);
}
