...
<table border="0" style="margin: 0 0 20px 0;" class="summary">
    <tr>
        <td><?php esc_html_e('Filename:', 'wordfence') ?></td>
        <td><?php echo wp_kses($localFile, array()); ?></td>
    </tr>
    <tr>
        <td><?php esc_html_e('File Size:', 'wordfence') ?></td>
        <td><?php echo $fileSize; ?></td>
    </tr>
    <tr>
        <td><?php esc_html_e('File last modified:', 'wordfence') ?></td>
