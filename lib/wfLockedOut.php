...
?>
    ...
    <div class="container">
        ...
        <ul>
            <li>
                <a href="<?php echo esc_url(site_url()); ?>"><?php esc_html_e('Return to the site home page', 'wordfence'); ?></a>
            </li>
            <li>
                <a href="<?php echo esc_url(admin_url()); ?>"><?php esc_html_e('Attempt to return to the admin login page (you may still be locked out)', 'wordfence'); ?></a>
            </li>
        </ul>
        ...
        <p class="generated small">
            <em><?php esc_html(printf(__('Generated by Wordfence at %s', 'wordfence'), gmdate('D, j M Y G:i:s T', wfWAFUtils::normalizedTime()))); ?>
                .<br><?php esc_html_e('Your computer\'s time:', 'wordfence'); ?>
