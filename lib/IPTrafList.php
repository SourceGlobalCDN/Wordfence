...
<table border="0" cellpadding="2" cellspacing="0" class="wf-recent-traffic-table">
	<?php foreach ($results as $key => $v) { ?>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo esc_url($v['URL']) ?>" target="_blank"
                   rel="noopener noreferrer"><?php echo esc_html($v['URL']); ?><span
		...
		<?php if ($v['referer']) { ?>
            ...
            <td>
                <a href="<?php echo esc_url($v['referer']); ?>" target="_blank"
                   rel="noopener noreferrer"><?php echo esc_html($v['referer']); ?><span
                            class="screen-reader-text"> (<?php esc_html_e('opens in new tab', 'wordfence') ?>)</span></a>
            </td></tr><?php } ?>
		<tr>
		...
		<?php if ($v['user']) { ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo esc_url($v['user']['editLink']); ?>" target="_blank"
                       rel="noopener noreferrer"><span data-userid="<?php echo esc_attr($v['user']['ID']); ?>"
                                                       class="wfAvatar"></span><?php echo esc_html($v['user']['display_name']); ?>
