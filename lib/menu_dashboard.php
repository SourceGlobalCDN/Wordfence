                                        ...
                                        <li>
                                            ...
                                            <?php elseif (wfConfig::get('keyType') == wfAPI::KEY_TYPE_PAID_CURRENT): ?>
                                                <div class="wf-block-labeled-value wf-protection-status wf-protection-status-<?php echo esc_attr($firewall->ruleMode()); ?>">
                                                    <div class="wf-block-labeled-value-value">
                                                        <i class="wf-fa wf-fa-check" aria-hidden="true"></i></div>
        ...
        (function ($) {
            $(function () {
                ...
                WFAD.tourComplete = function () {
                    WFAD.tourFinish('<?php echo esc_attr(wfOnboardingController::TOUR_DASHBOARD); ?>');
                };
    ...
    <script type="application/javascript">
        (function ($) {
            $(function () {
                ...
                WFAD.colorboxHTML((WFAD.isSmallScreen ? '300px' : '700px'), promptHTML, {
